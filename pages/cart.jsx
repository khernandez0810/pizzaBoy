...
const Cart = () => {
    ...
    const createOrder = async (data) => {
        try {
            const res = await axios.post("https://pizza-boy.vercel.app/api/orders", data)
    ...
    <div className={styles.container}>
        <div className={styles.left}>
            <table className={styles.table}>
                ...
                <tr className={styles.tr} key={product._id}>
                    ...
                    <td><span className={styles.total}>${product.price * product.quantity}</span>
                    </td>
                </tr>
                 ))}
                </tbody>
        ...
        {open ? (
            <div className={styles.paymentMethods}>
                ...
                <PayPalScriptProvider
                options={{
                    "clientId": "AQtZ-HgnksikDDxZtOCLzAIal9munq-2XdY5zJRvp0RqumqDkzFWhOd8gGJ1TX4Y7iI5gSK7W_wtpCZa",
                    components: "buttons",
                    currency: "USD",
